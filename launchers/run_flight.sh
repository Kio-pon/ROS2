#!/bin/bash
# A unified script to run the entire simulation and autonomous flight.
...
# 5. Run the ROS 2 Autonomous Mission Python script
echo "Launching autonomous_mission.py flight node..."
source ~/px4_ros2_ws/install/setup.bash
ros2 run drone_controller autonomous_mission
