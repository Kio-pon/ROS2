...
WORLDS = sorted(glob.glob(os.path.join(WORKSPACE_ROOT, "custom_worlds", "*.sdf")))
ENV = dict(os.environ, GZ_SIM_RESOURCE_PATH=os.path.join(WORKSPACE_ROOT, "custom_models") + ":" + os.environ.get("GZ_SIM_RESOURCE_PATH", ""))
